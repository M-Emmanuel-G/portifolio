...
export default function CardProject({title, link, description, imgURL}:CardProps) {
 return (
    <Card className="w-[235px] h-[200px] flex justify-center text-center items-between my-4 flex-col p-0 bg-black text-white border-none">
        <CardHeader className="w-full h-1/2 flex flex-col p-0">
            <CardTitle className="text-sm p-0 text-cyan-400 mt-2">{title}</CardTitle>
